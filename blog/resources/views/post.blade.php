						...
						<div class="post-icons-area">
							<ul class="post-icons">
								<li>
                                    ...
                                    <form id="favorite-form-{{$post->id}}" action="{{route('post.favorite', $post->id)}}" style="display: none;" method="POST">@csrf
                                    </form>
                                    @endguest
                                    </li>
					...
					<div class="single-post info-area">
						...
						<div class="sidebar-area subscribe-area">
							...
							<div class="input-area">
								<form method="POST" action="{{route('subscriber.store')}}">@csrf
							...
							<div class="blog-info">
								...
								<ul class="post-footer">
									<li>
                                        ...
                                        <form id="favorite-form-{{$randompost->id}}" action="{{route('post.favorite', $randompost->id)}}" style="display: none;" method="POST">@csrf
                                        </form>
                                        @endguest
                                        </li>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-8 col-md-12">
					...
					<form method="post" action="{{route('comment.store',$post->id)}}">@csrf
							<div class="row">
								<div class="col-sm-12">
